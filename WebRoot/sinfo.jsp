...
<BODY text=#000000 bgColor=#ffffff leftMargin=0 topMargin=0>
     ...
     <TABLE class=dragTable cellSpacing=0 cellPadding=0 width="100%" border=0>
      ...
      <td  align="center">点击率</td> 
                    ...
                    fenlei=Common.toChineseAndTrim(fenlei);
                    String title=request.getParameter("title");
                    title=Common.toChineseAndTrim(title);
                    String ipaddress=request.getRemoteAddr();
                    String member=(String)session.getAttribute("member");
                    if(member==null)member=ipaddress;
                    cb.comUp("insert into keyword(fenlei,title,member,sj) values('"+fenlei+"','"+title+"','"+member+"','"+date2+"'  )");
